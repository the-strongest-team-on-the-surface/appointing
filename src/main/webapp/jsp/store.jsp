                    ...
                    <div class="col-sm-8">
                        <form class="form-horizontal" onsubmit="return fnSignup()">
                            ...
                            <div class="form-group row has-feedback" id="dtelnum">
                                ...
                                <div class="col-sm-9">
                                    <input onchange="fretel()" type="text" class="form-control" id="telnum"
                                        placeholder="">
                            ...
                            <div class="form-group row has-feedback" id="dname">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" onchange="frename()" class="form-control" id="name"
                                        placeholder=""><span id="sname"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <small id="sexHelp" class="form-text text-muted">请选择理发师的性别</small>
                                </div>
                            </div>
